...
var npmaki = require('npmap-symbol-library/www/npmaki-sprite.json');
...
css += ".preset-icon-npmaki{background-image:url(img/npmaki-sprite.png);background-repeat:no-repeat;width:24px;height:24px;}\n";
...
_.forEach(npmaki, function(dimensions, name) {
    var match = name.match(/(.*)-(12|18|24)/),
        name = match[1],
        size = match[2],
        group = images.npmaki[name] = images.npmaki[name] || {};
    group[size] = [dimensions.x, dimensions.y];
