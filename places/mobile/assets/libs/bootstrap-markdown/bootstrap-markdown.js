  ...
  , showEditor: function() {
      ...
      if (this.$editor == null) {
        ...
        if (options.fullscreen.enable) {
          editorHeader.append('<div class="md-controls"><button class="btn btn-link md-control md-control-fullscreen" href="#"><span class="'+this.__getIcon(options.fullscreen.icons.fullscreenOn)+'"></span></button></div>').on('click', '.md-control-fullscreen', function(e) {
              e.preventDefault();
