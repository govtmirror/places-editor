...
b===a&&w.slice(0,h).addClass("disabled");b===f&&w.slice(g+1).addClass("disabled");c="";b=10*parseInt(b/10,10);s=this.picker.find(".datepicker-years").find("th:eq(1)").text(b+"-"+(b+9)).end().find("td");--b;q=d.map(this.dates,function(a){return a.getUTCFullYear()});for(g=-1;11>g;g++)h=["year"],-1===g?h.push("old"):10===g&&h.push("new"),-1!==d.inArray(b,q)&&h.push("active"),(b<a||b>f)&&h.push("disabled"),c+='<span class="'+h.join(" ")+'">'+b+"</span>",b+=1;s.html(c)},updateNavArrows:function(){if(this._allow_update){var a=
...
h.data("datepicker",f=new u(this,g))}if("string"===typeof a&&"function"===typeof f[a]&&(c=f[a].apply(f,b),c!==t))return!1});return c!==t?c:this};var y=d.fn.datepicker.defaults={autoclose:!1,beforeShowDay:d.noop,calendarWeeks:!1,clearBtn:!1,daysOfWeekDisabled:[],endDate:Infinity,forceParse:!0,format:"mm/dd/yyyy",keyboardNavigation:!0,language:"en",minViewMode:0,multidate:!1,multidateSeparator:",",orientation:"auto",rtl:!1,startDate:-Infinity,startView:0,todayBtn:!1,todayHighlight:!1,weekStart:0},E=
d.fn.datepicker.locale_opts=["format","rtl","weekStart"];d.fn.datepicker.Constructor=u;var m=d.fn.datepicker.dates={en:{days:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "),daysShort:"Sun Mon Tue Wed Thu Fri Sat Sun".split(" "),daysMin:"Su Mo Tu We Th Fr Sa Su".split(" "),months:"January February March April May June July August September October November December".split(" "),monthsShort:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),today:"Today",clear:"Clear"}},
n={modes:[{clsName:"days",navFnc:"Month",navStep:1},{clsName:"months",navFnc:"FullYear",navStep:1},{clsName:"years",navFnc:"FullYear",navStep:10}],isLeapYear:function(a){return 0===a%4&&0!==a%100||0===a%400},getDaysInMonth:function(a,b){return[31,n.isLeapYear(a)?29:28,31,30,31,30,31,31,30,31,30,31][b]},validParts:/dd?|DD?|mm?|MM?|yy(?:yy)?/g,nonpunctuation:/[^ -\/:-@\[\u3400-\u9fff-`{-~\t\n\r]+/g,parseFormat:function(a){var b=a.replace(this.validParts,"\x00").split("\x00");a=a.match(this.validParts);
if(!b||!b.length||!a||0===a.length)throw Error("Invalid date format.");return{separators:b,parts:a}},parseDate:function(a,b,c){function h(){var a=this.slice(0,g[k].length),b=g[k].slice(0,a.length);return a===b}if(!a)return t;if(a instanceof Date)return a;"string"===typeof b&&(b=n.parseFormat(b));var f=/([\-+]\d+)([dmwy])/,g=a.match(/([\-+]\d+)([dmwy])/g),e,k;if(/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(a)){a=new Date;for(k=0;k<g.length;k++)switch(b=f.exec(g[k]),e=parseInt(b[1]),b[2]){case "d":a.setUTCDate(a.getUTCDate()+
e);break;case "m":a=u.prototype.moveMonth.call(u.prototype,a,e);break;case "w":a.setUTCDate(a.getUTCDate()+7*e);break;case "y":a=u.prototype.moveYear.call(u.prototype,a,e)}return r(a.getUTCFullYear(),a.getUTCMonth(),a.getUTCDate(),0,0,0)}g=a&&a.match(this.nonpunctuation)||[];a=new Date;var f={},s="yyyy yy M MM m mm d dd".split(" ");e={yyyy:function(a,b){return a.setUTCFullYear(b)},yy:function(a,b){return a.setUTCFullYear(2E3+b)},m:function(a,b){if(isNaN(a))return a;for(--b;0>b;)b+=12;b%=12;for(a.setUTCMonth(b);a.getUTCMonth()!==
b;)a.setUTCDate(a.getUTCDate()-1);return a},d:function(a,b){return a.setUTCDate(b)}};var l;e.M=e.MM=e.mm=e.m;e.dd=e.d;a=r(a.getFullYear(),a.getMonth(),a.getDate(),0,0,0);var q=b.parts.slice();g.length!==q.length&&(q=d(q).filter(function(a,b){return-1!==d.inArray(b,s)}).toArray());if(g.length===q.length){var p;k=0;for(p=q.length;k<p;k++){l=parseInt(g[k],10);b=q[k];if(isNaN(l))switch(b){case "MM":l=d(m[c].months).filter(h);l=d.inArray(l[0],m[c].months)+1;break;case "M":l=d(m[c].monthsShort).filter(h),
l=d.inArray(l[0],m[c].monthsShort)+1}f[b]=l}for(k=0;k<s.length;k++)b=s[k],b in f&&!isNaN(f[b])&&(c=new Date(a),e[b](c,f[b]),isNaN(c)||(a=c))}return a},formatDate:function(a,b,c){if(!a)return"";"string"===typeof b&&(b=n.parseFormat(b));c={d:a.getUTCDate(),D:m[c].daysShort[a.getUTCDay()],DD:m[c].days[a.getUTCDay()],m:a.getUTCMonth()+1,M:m[c].monthsShort[a.getUTCMonth()],MM:m[c].months[a.getUTCMonth()],yy:a.getUTCFullYear().toString().substring(2),yyyy:a.getUTCFullYear()};c.dd=(10>c.d?"0":"")+c.d;c.mm=
(10>c.m?"0":"")+c.m;a=[];for(var h=d.extend([],b.separators),f=0,g=b.parts.length;f<=g;f++)h.length&&a.push(h.shift()),a.push(c[b.parts[f]]);return a.join("")},headTemplate:'<thead><tr><th class="prev">&laquo;</th><th colspan="5" class="datepicker-switch"></th><th class="next">&raquo;</th></tr></thead>',contTemplate:'<tbody><tr><td colspan="7"></td></tr></tbody>',footTemplate:'<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="clear"></th></tr></tfoot>'};n.template='<div class="datepicker"><div class="datepicker-days"><table class=" table-condensed">'+
n.headTemplate+"<tbody></tbody>"+n.footTemplate+'</table></div><div class="datepicker-months"><table class="table-condensed">'+n.headTemplate+n.contTemplate+n.footTemplate+'</table></div><div class="datepicker-years"><table class="table-condensed">'+n.headTemplate+n.contTemplate+n.footTemplate+"</table></div></div>";d.fn.datepicker.DPGlobal=n;d.fn.datepicker.noConflict=function(){d.fn.datepicker=F;return this};d(document).on("focus.datepicker.data-api click.datepicker.data-api",'[data-provide="datepicker"]',
